...
const Navbar = () => {
  ...
  return (
    <motion.header
      className="bg-base-100 border-b border-base-200 p-4 shadow-sm fixed top-0 left-64 right-0 z-30"
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          <button className="md:hidden mr-4 text-base-content hover:text-primary">
            <FiMenu size={24} />
          </button>
        ...
        <div className="flex items-center space-x-4">
          <button className="relative p-2 text-base-content hover:text-primary">
            <FiBell size={20} />
            <span className="absolute top-0 right-0 w-2 h-2 bg-red-500 rounded-full"></span>
          </button>
          <motion.button
            onClick={toggleTheme}
            className="p-2 text-base-content hover:text-primary rounded-full bg-base-200"
